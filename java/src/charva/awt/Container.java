...
public abstract class Container
    ...
    public Component add(Component component_) {
        ...
        if (_layoutMgr != null && _layoutMgr instanceof LayoutManager2) {
            if (_layoutMgr instanceof BorderLayout) {
                ((BorderLayout) _layoutMgr).addLayoutComponent(component_, BorderLayout.CENTER);
            } else {
    ...
    public void add(Component component_, Object constraint_) {
        ...
        if (_layoutMgr != null && _layoutMgr instanceof LayoutManager2) {
            ((LayoutManager2) _layoutMgr).addLayoutComponent(component_, constraint_);
        }
    }
     ...
     *         never null.
     * @throws IllegalComponentStateException if there is no
