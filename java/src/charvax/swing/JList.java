    ...
    public void processKeyEvent(KeyEvent ke_) {
        ...
        switch (key) {
            ...
            case KeyEvent.VK_END:
                _currentRow = _listModel.getSize() - 1;
                evtqueue.postEvent(new ScrollEvent(this, ScrollEvent.UP, new Point(0, _currentRow)));
                break;
            ...
            case KeyEvent.VK_UP:
                ...
                evtqueue.postEvent(new ScrollEvent(this, ScrollEvent.DOWN, new Point(0, --_currentRow)));
                break;
